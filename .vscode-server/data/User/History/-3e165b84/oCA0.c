...
list. */
void makedir(struct fileNode** head_ref, char new_data[])
{
...
if (stat(("/home/jtorne2/.idea/%s",new_node->filename), &st) == -1) {
	...
	/* 3. Make ri of new node as head and previous as NULL
	*/
	new_node->ri = (*head_ref);
	new_node->prev = NULL;
...
// 	/* 4. Make ri of new node as ri of prev_node */
// 	new_node->ri = prev_node->ri;

// 	/* 5. Make the ri of prev_node as new_node */
// 	prev_node->ri = new_node;

// 	/* 6. Make prev_node as previous of new_node */
// 	new_node->prev = prev_node;

// 	/* 7. Change previous of new_node's ri node */
// 	if (new_node->ri != NULL)
// 		new_node->ri->prev = new_node;
// }
...
// 	// 1->7->8->6->4->NULL
// 	insertAfter(head->ri, "groceryList.txt");
