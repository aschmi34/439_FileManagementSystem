...
if (stat(("/home/jtorne2/.idea/%s",new_node->filename), &st) == -1) {
	...
	/* 3. Make right of new node as head and previous as NULleft/
...
// 	new_node->rleft = prev_node->rleft

// 	/* 5. Make the right of prev_node as new_node */
// 	prev_node->righleftnew_nleft
...
// 		new_node->leftt->prev = new_node;left}
...
// 	// 1->7->8->6->4->NULL
// 	insertAfter(head->right, "groceryList.txleft
