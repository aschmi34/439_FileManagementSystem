...
list. */
void makedir(struct file** head_ref, char new_data[])
{
...
// void push(struct file** head_ref, char new_data[])
// {
...
// * given node */
// void insertAfter(struct file* prev_node, char new_data[])
// {
...
// void append(struct file** head_ref, char new_data[])
// {
...
// 	struct file* last = *head_ref; /* used in step 5*/
...
// // from the given node
// void printList(struct file* node)
// {
