...
list. */
struct fileNode *pushdir(int level,char new_data[])
{
    return makeTdir(level,new_data);
}
...
struct fileNode *insertRight(struct fileNode *prev_node, char new_data[])
{
    ...
    printf("\n insertR: %s/%s",prev_node->filename);
...
{
        printf("\n insertL: %s/%s",prev_node->filename);
...
struct fileNode *insertRightF(struct fileNode *prev_node, char new_data[])
{
    ...
    printf("\n insertRF: %s/%s",prev_node->filename);
...
struct fileNode *insertleftF(struct fileNode *prev_node, char new_data[])
{
    ...
    printf("\n insertLF: %s/%s",prev_node->filename);
...
struct fileNode *removeleftF(struct fileNode *prev_node, char new_data[])
{

    prev_node->left->left = deleteLNode(prev_node, new_data);
    return prev_node->left->left;
}
struct fileNode *removeRightF(struct fileNode *prev_node, char new_data[])
{
